 ...
 * @extends {BigBitField}
 */
export default class WebhookFilters extends BitField {}
...
WebhookFilters.FLAGS = {
  ...
  CREATE_CUSTOM_FIELD: 1n << 70n,
  DELETE_CUSTOM_FIELD: 1n << 71n,
  UPDATE_CUSTOM_FIELD_ITEM: 1n << 72n,
  // #endregion
  ...
  // #region UPDATE_CUSTOM_FIELD subtypes [700]
  UPDATE_CUSTOM_FIELD_NAME: 1n << 700n,
  UPDATE_CUSTOM_FIELD_DISPLAY: 1n << 701n
  // #endregion
};
 ...
 * @type {BigInt}
 */
export const ALL = Object.values(WebhookFilters.FLAGS).reduce((all, p) => all | p, 0n);

/**
 * Bitfield representing default permissions
 * @type {BigInt}
 */
export const DEFAULT = new WebhookFilters([
