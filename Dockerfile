...
# ---- Builder ----
FROM --platform=$BUILDPLATFORM node:18.20.8-alpine3.20 AS builder
...
# ---- Dependencies ----
FROM --platform=$BUILDPLATFORM node:18.20.8-alpine3.20 AS deps
...
# ---- Runner ----
FROM --platform=$BUILDPLATFORM node:18.20.8-alpine3.20
